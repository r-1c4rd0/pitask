    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: ListView(
          ...
          shrinkWrap: false,
          children: <Widget>[
            Text("Subscriptions History".tr, style: Get.textTheme.headlineSmall),
            Obx(() {
              if (controller.eProviderSubscriptions.isEmpty) return SubscriptionsListLoaderWidget(count: 4, itemHeight: 0.0,);
